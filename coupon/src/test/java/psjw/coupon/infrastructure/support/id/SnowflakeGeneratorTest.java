package psjw.coupon.infrastructure.support.id;

import jdk.swing.interop.SwingInterOpUtils;
import org.assertj.core.api.Assertions;
import org.junit.jupiter.api.DisplayName;
import org.junit.jupiter.api.Test;
import psjw.coupon.common.error.id.InvalidNodeIdException;
import psjw.coupon.common.error.id.InvalidSystemClockException;
import psjw.coupon.common.error.id.SnowflakeTimeoutException;
import psjw.coupon.common.time.InstantTimeProvider;
...
class SnowflakeGeneratorTest {
    ...
    void generate_whenCalled_thenReturnNotNullId() {
        ...
        generator = new SnowflakeGenerator(testProps, nodeId, timeProvider);
        //when
